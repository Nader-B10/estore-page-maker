  ...
  <header class="bg-surface shadow-sm border-b border-gray-200/10 p-4 sticky top-0 z-50">
    <div class="container mx-auto flex justify-between items-center">
      ...
      <nav class="hidden md:flex gap-6">
        <a href="#products" class="text-subtle-text hover:text-text">المنتجات</a>
        <a href="#why-us" class="text-subtle-text hover:text-text">لماذا نحن</a>
        <a href="#faq" class="text-subtle-text hover:text-text">الأسئلة الشائعة</a>
      </nav>
